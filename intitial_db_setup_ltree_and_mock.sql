...
-- create threads/msgs
INSERT INTO msgs VALUES       (1, 1, 1, NULL, NULL, CURRENT_TIMESTAMP, 'YouTube etc empfehlenswerte Videogamefilmchen', 'Vorgänger: LINK', FALSE, '1');
  INSERT INTO msgs VALUES     (1, 2, 1, 1, 1, CURRENT_TIMESTAMP, 'Re: YouTube etc empfehlenswerte Videogamefilmchen', 'Ein super Youtube-Video', FALSE, '1.2');
    INSERT INTO msgs VALUES   (1, 3, 1, 2, 1, CURRENT_TIMESTAMP, 'Danke für dieses Video', 'Es gefiel.', FALSE, '1.2.3');
      INSERT INTO msgs VALUES (1, 4, 1, 3, 1, CURRENT_TIMESTAMP, 'Mir nicht /nt', '', FALSE, '1.2.3.4');
      INSERT INTO msgs VALUES (1, 5, 1, 3, 1, CURRENT_TIMESTAMP, 'Mir auch /nt', '', FALSE, '1.2.3.5');
  INSERT INTO msgs VALUES     (1, 6, 1, 1, 1, CURRENT_TIMESTAMP, 'Typ macht Hades-Speedrun auf dem Klo', 'Hades ist nämlich ein gutes Spiel', FALSE, '1.6');

INSERT INTO msgs VALUES       (1, 7, 1, NULL, NULL, CURRENT_TIMESTAMP, 'Ich zocke gerade', 'Also ich zock gerade gar nix.', FALSE, '7');
  INSERT INTO msgs VALUES     (1, 8, 1, 7, 1, CURRENT_TIMESTAMP, 'Hades', 'Auf dem Klo', FALSE, '7.8');
    INSERT INTO msgs VALUES   (1, 11, 1, 8, 1, CURRENT_TIMESTAMP, 'WTF', 'BIST DU DAS MIT DEM SPEEDRUN?!1elf', FALSE, '7.8.11');
  INSERT INTO msgs VALUES     (1, 9, 1, 7, 1, CURRENT_TIMESTAMP, 'Minesweeper', 'Ist aber nicht so gut.', FALSE, '7.9');
    INSERT INTO msgs VALUES     (1, 12, 1, 9, 1, CURRENT_TIMESTAMP, 'Find ich auch', 'LOL, natürlich ist das gut!1', FALSE, '7.9.12');
  INSERT INTO msgs VALUES     (1, 10, 1, 7, 1, CURRENT_TIMESTAMP, 'Diablo EINS', 'Die anderen geben mir nix. ¯\_(ツ)_/¯', FALSE, '7.10');
    INSERT INTO msgs VALUES     (1, 13, 1, 10, 1, CURRENT_TIMESTAMP, 'Re: Diablo EINS', 'Ah, a man of culture!', FALSE, '7.10.13');
